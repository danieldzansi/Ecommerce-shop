    ...
    heroSlides: [
        {
            ...
            title: 'Meet New Arrivals',
            titleLines: ['Meet New', 'Arrivals'],
            text: 'Beautiful pieces chosen to complement your everyday style.',
            cta: 'Shop now',
            fit: 'cover',
            position: 'center 18%',
            background: '#f5f3ef',
        ...
        },
        {
            ...
            text: 'Wardrobe favourites for everyday moments and occasions that call for more.',
            cta: 'Shop the edit',
